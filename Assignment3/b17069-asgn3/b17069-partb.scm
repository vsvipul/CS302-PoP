...
(define (list-of-args procedure-params exps env)
  (if (no-operands? exps) '()
      (cons (if (lazy? (first-operand procedure-params))
                (delay-it (first-operand exps) env)
                (myeval (first-operand exps) env))
            (list-of-args (rest-operands procedure-params) (rest-operands exps) env))))
...
(define (make-frame variables values)
  (let ((frame-to-return (cons nil nil)))
  (map (lambda (var val)
       (add-binding-to-frame! (get-var var) (get-val val var) frame-to-return))
       variables
       values)
  ;(display frame-to-return) (newline)
  frame-to-return))
...
(define (lookup-variable-value var env)
 ; (display var) (newline) (display env) (newline)
  (define (env-loop env)
